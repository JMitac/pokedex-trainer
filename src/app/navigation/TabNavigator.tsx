...
// Color fijo para el badge "DEV" — no depende de la paleta de tipos Pokémon
...
export const TabNavigator: React.FC = () => (
  <Tab.Navigator
    ...
    screenOptions={{
      headerShown: false,
      // Sin `height` ni `paddingBottom` explícitos — React Navigation
      // calcula el safe area inferior automáticamente. Forzar estos
      // valores es lo que generaba el hueco duplicado en iOS.
      tabBarStyle: {
